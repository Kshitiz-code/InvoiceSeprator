...
public class folderToExcel {
    ...
    public static void main(String[] args) {
        ...
        String outputFilePath = "C:\\Users\\KSGUPTA\\Documents\\output.xlsx";
        ...
        try {
            ...
            if (files != null) {
                ...
                Sheet sheet = workbook.createSheet("Seprated Invoice Details");

                Row headerRow = sheet.createRow(0);
                String[] headers = {"File Name", "CUS", "SPL", "CPO", "PNR", "INV", "INQ", "PAY"};
                ...
                for (File inputFile : files) {
                    ...
                    fileNameCell.setCellValue(inputFile.getName());

                    String[] data = extractData(inputData);

                    for (int i = 0; i < data.length; i++) {
                        Cell cell = dataRow.createCell(i + 1); // Start from column 1, leaving space for the file name
